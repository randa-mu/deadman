...
A full-stack TypeScript monorepo starter with shared types, using Bun, Hono, Vite, React, and Shadcn.
Forked and modified from [bhvr](https://github.com/stevedylandev/bhvr). Follow the README there for general instructions

Add components by following the bun instructions from the [shadcdn docs](https://ui.shadcn.com/docs/installation/vite)
...
- **Modern Stack**:
  ...
  - [Shadcn](https://ui.shadcn.com/docs/) for nice UI components
